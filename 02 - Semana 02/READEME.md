...
Caso o número ainda não seja igual o programa soma 1 (ADD) ao valor de atual (NUM1 - NUM 2) e armazena esse resultado (datNUM1) e por fim manda o programa novamente para o loop(BRA) e repetir o processo até o final.
